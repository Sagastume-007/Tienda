...
class Container(customtkinter.CTk):
    def __init__(self):
        super().__init__()
    ...
    def widgets(self):
        ...
        frame1 = tk.Frame(self, bg="Mediumaquamarine")
        frame1.pack()
        frame1.place(x=0, y=0, width=800, height=400)

        self.button = customtkinter.CTkButton(master=self, text="Ir a ventas", command=self.ventas)
        self.button.grid(row=1, column=1, padx=500, pady=20, sticky="n")
